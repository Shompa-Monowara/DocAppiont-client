                ...
                >
                    ...
                    <div className="flex items-center flex-row justify-end gap-3 pt-4 lg:pt-0 border-t lg:border-t-0 border-slate-100/80 shrink-0 w-full lg:w-auto">
                        <button
                            ...
                            className="flex-1 lg:flex-none flex items-center justify-center gap-2 px-4 py-2.5 bg-slate-50 hover:bg-slate-100 border border-slate-200 rounded-xl text-sm font-semibold text-slate-700 transition-all cursor-pointer lg:w-32 active:scale-98"
                        >
                            <FaPencilAlt className="w-3 h-3 text-slate-500" />
                            Update
                        </button>
