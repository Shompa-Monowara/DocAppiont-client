                  ...
                  <div className="flex flex-wrap gap-4 mb-12">
                    ...
                    <Link href="/dashboard">
                      <Button
                        size="lg"
                        variant="bordered"
                        className="font-bold px-8 rounded-xl transition-all duration-200 border-white/30 text-white"
                        style={{
                        ...
                        onMouseEnter={(e) => {
                          ...
                          e.currentTarget.style.boxShadow = `inset 0 1px 0 rgba(255,255,255,0.25), 0 4px 20px rgba(46,216,227,0.15)`;
                        }}
                        onMouseLeave={(e) => {
                          e.currentTarget.style.borderColor = 'rgba(255,255,255,0.3)';
                          e.currentTarget.style.color = '#ffffff';
                          e.currentTarget.style.backgroundColor = 'rgba(255, 255, 255, 0.12)';
                          e.currentTarget.style.boxShadow = 'inset 0 1px 0 rgba(255,255,255,0.2), 0 4px 16px rgba(0,0,0,0.2)';
                        }}
